...
2. Install external dependencies, three options:
	...
	- download a pre-build singularity image from https://zenodo.org/records/15591478 and do all subsequent operations within that image, see UWLCM/singularity/README_singularity.md for details; Note that using this pre-build image will probably not work for MPI runs or will give poor performance
	- installation with Spack, see UWLCM/spack/README_spack.md for details
