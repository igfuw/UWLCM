...
dycoms_profs = ["rliq", "prflux", "cl_nc"]
dycoms_series = ["lwp", "surf_precip", "cl_nc"]
...
plot_iter = plot_series(dycoms_series, plot_iter, nplotx, nploty, axarr, True, suffix="series.dat", xlabel='Time [h]')
plot_iter = plot_profiles(dycoms_profs, plot_iter, nplotx, nploty, axarr, True, suffix="profiles_7200_21600.dat", ylabel = '$z/z_i$')
