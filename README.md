...
Build instructions can be found in build_instructions.md (model dependencies can be manually installed, installed with Spack or the model can be ran in a Singularity image).
