...
int main(int ac, char** av)
{
  ...
  tests.push_back({
    ...
    // epsilons map
    {
      ...
      {"lgrngn", {{1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 2.5e-2, 3e-2, 4e-2, 6e-2, 8e-2}} }
    }
  });
  ...
  tests.push_back({
    ...
    // epsilons map
    {
      ...
      {"lgrngn", {{1e-2, 6e-2, 6e-2, 6e-2, 6e-2, 6e-2, 6e-2, 6e-2, 6e-2, 11e-2, 11e-2}} } 
    }
  });
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{1e-2, 1e-2, 1e-2, 1e-2, 1e-2, 2e-2, 2.5e-2, 2.5e-2, 4e-2, 5e-2, 6e-2}} } 
    }
  });
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{1e-2, 2e-2, 2e-2, 2e-2, 4e-2, 4e-2, 8e-2, 8e-2, 8e-2, 15e-2, 15e-2}} } 
    }
  });
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{1e-2, 1e-2, 2e-2, 4e-2, 4e-2, 4e-2, 4e-2, 9e-2, 10e-2, 20e-2, 40e-2}} } 
    }
  });
...
*/
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{1e-2, 1e-2, 1e-2, 1.5e-2, 3e-2, 4.5e-2, 7e-2, 9e-2, 10e-2, 12e-2, 12e-2}} } 
    }
  });
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{1e-2, 3e-2, 7e-2, 7e-2, 7.5e-2, 7.5e-2, 8e-2, 8e-2, 8e-2, 8e-2, 12e-2}} } 
    }
  });
