...
int main(int ac, char** av)
{
  ...
  tests.push_back({
    ...
    // expected values map
    {
      {"blk_1m", {{0, 0, 0.0189641, 0.0669555, 0.137429, 0.208473, 0.266551, 0.30766, 0.333871, 0.310118, 0.232963}}},
  ...
  tests.push_back({
    ...
    {
      {"blk_1m", {{1e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 2e-2, 5e-2, 2e-1}} },
      {"lgrngn", {{10e-2, 10e-2, 15e-2, 12e-2, 10e-2, 20e-2, 15e-2, 10e-2, 10e-2, 15e-2, 20e-2}} } 
    }
  });
  ...
  */
  ...
  tests.push_back({
    ...
    // expected values map
    {
      {"blk_1m", {{0, 0, 0.0232409, 0.0246564, 0.0257979, 0.0266198, 0.0265741, 0.0247477, 0.0227843, 0.0195881, 0.016118}}},
