...
int main(int ac, char** av)
{
  ...
  string opts_common = 
    "--outfreq=200 --nt=12000 --spinup=9600 --nx=96 --nz=300 --dt=0.75 --z_rlx_sclr=100 ";
  set<string> opts_micro({
    "--adv_serial=false --async=true --micro=lgrngn --outdir=out_lgrngn_d1 --backend=CUDA --sd_conc=2048 --case=dycoms_rf01 --rng_seed=44 \
