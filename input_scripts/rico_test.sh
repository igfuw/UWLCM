...
# output directory
OUTPUT_DIR=$HOME/output/rico_test/explicit_aerosols
...
#MICRO_PARAMS="--micro=lgrngn --sd_conc=40"
...
#srun singularity exec --nv $CONTAINER $MODEL --outdir=$OUTPUT_DIR $CASE_PARAMS $RUN_PARAMS $COMMON_PARAMS $MICRO_PARAMS
echo done!
