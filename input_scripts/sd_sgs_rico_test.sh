...
#SBATCH --job-name=test-rico			# job name
...
# output directory
OUTPUT_DIR=$HOME/output/testing/rico_test/flux_sgs/
...
TURB_PARAMS="--sgs=1 --turb_adve=1"
MICRO_PARAMS="--micro=lgrngn --sd_conc=40 --mean_rd1=$MU1 --sdev_rd1=$SIG1 --n1_stp=$N1 --kappa1=$KAP1 --mean_rd2=$MU2 --sdev_rd2=$SIG2 --n2_stp=$N2 --kappa2=$KAP2"
