...
//  bool unit_test = vm["unit_test"].as<bool>();
  ...
  setup::arr_1D_t neg_w_LS = rt_params.profs.w_LS->copy(); 
  ...
  rt_params.cloudph_opts_init.SGS_mix_len = std::vector<setup::real_t>(rt_params.profs.mix_len->begin(), rt_params.profs.mix_len->end());
