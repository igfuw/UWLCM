...
int main(int argc, char** argv)
{
...

  {
    ...
    opts_main.add_options()
      ...
      ("case", po::value<std::string>()->default_value("moist_thermal"), "one of: dry_thermal, moist_thermal, dycoms_rf01, dycoms_rf02, cumulus_congestus_icmw20, cumulus_congestus_icmw24, rico11, dry_pbl, contrail")
