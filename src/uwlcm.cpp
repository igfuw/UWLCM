...
int main(int argc, char** argv)
{
...

  {
    ...
    opts_main.add_options()
      ...
      ("X", po::value<int>()->default_value(-1) , "domain size in X [m] (set negative for case default)")
      ("Y", po::value<int>()->default_value(-1) , "domain size in Y [m] (set negative for case default)")
      ("Z", po::value<int>()->default_value(-1) , "domain size in Z [m] (set negative for case default)")
