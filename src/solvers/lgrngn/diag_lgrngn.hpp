...
//    // recording 3rd wet mom of radius of aerosols (r < 3.5um)
  ...
  // recording 0th wet mom of radius of ice
  prtcls->diag_ice();
  prtcls->diag_wet_mom(0);
  this->record_aux("ice_rw_mom0", prtcls->outbuf());

  // recording 1st wet mom of radius of ice
  prtcls->diag_ice();
  prtcls->diag_wet_mom(1);
  this->record_aux("ice_rw_mom1", prtcls->outbuf());

  // recording 2nd wet mom of radius of ice
  prtcls->diag_ice();
  prtcls->diag_wet_mom(2);
  this->record_aux("ice_rw_mom2", prtcls->outbuf());

  // recording 3rd wet mom of radius of ice
  prtcls->diag_ice();
  prtcls->diag_wet_mom(3);
  this->record_aux("ice_rw_mom3", prtcls->outbuf());
