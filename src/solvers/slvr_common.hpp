  ...
  */
  ...
  void hook_ante_loop(int nt)
  {
    ...
    if(this->rank==0)
    {
      ...
      this->record_aux_const("rd_insol1", "user_params", params.user_params.rd_insol1 / si::metres);
      ...
      this->record_aux_const("rd_insol2", "user_params", params.user_params.rd_insol2 / si::metres);
