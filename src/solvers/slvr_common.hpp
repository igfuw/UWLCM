  ...
  */
  ...
  void hook_ante_loop(int nt) 
  {
    ...
    params.update_surf_flux_sens(
      ...
      *params.rhod, params.dz, 0, this->dt, this->di, this->dj
    );
...
*/
  ...
  { 
    ...
    std::function<void(typename parent_t::arr_t, typename parent_t::arr_t, typename parent_t::arr_t, typename setup::arr_1D_t, const real_t&, int, const real_t&, const real_t&, const real_t&)> update_surf_flux_uv, update_surf_flux_sens, update_surf_flux_lat;
  };
