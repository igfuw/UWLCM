...
namespace setup 
{
  ...
  class CasesCommon
  {
    ...
    virtual void update_surf_flux_sens(typename concurr_t::solver_t::arr_sub_t &surf_flux_sens, int timestep, real_t dt) {}; // empty for setups that don't need surface fluxes
    virtual void update_surf_flux_lat(typename concurr_t::solver_t::arr_sub_t &surf_flux_lat, int timestep, real_t dt) {};
